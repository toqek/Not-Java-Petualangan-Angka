...
public class GMPengurangan : MonoBehaviour
{
    ...
    //untuk membuat soal baru dengan jawaban benar dan jawaban salah, serta menempatkan gerbang jawaban di posisi yang sesuai
    void BuatSoal()
    {
